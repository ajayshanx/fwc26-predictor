      ...
      <div className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <div className="text-white font-extrabold text-sm sm:text-base leading-tight tracking-tight">
              FIFA WORLD CUP 2026
            </div>
            <div className="text-gold text-xs font-semibold tracking-widest hidden sm:block">
        ...
        <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
          ...
          {groups.length > 0 && (
            <select
              ...
              className="bg-navy-600 border border-navy-400 rounded-lg px-2 py-1.5 text-sm
                         text-white focus:outline-none focus:border-gold max-w-[130px] sm:max-w-[180px]"
            >
              {groups.map(g => (
          ...
          {groups.length === 0 && (
            <span className="text-slate-500 text-xs italic">No group yet</span>
          )}
...
function StatChip({ label, value, highlight }) {
  return (
    <div className={`rounded-lg px-3 py-1.5 text-center min-w-[64px] border
      ${highlight
